export default {
  ...
  login: {
    ...
    message: {
      verifyUserName: "please enter user name",
      verifyEmail: "Please enter email",
      verifyCaptcha: "Please enter verification code",
      verifyPassword: "Please enter password",
      verifyPassword2: "Passwords do not match",
      verifyEmailFormat: "Incorrect email format",
      sentSuccessfully: "Verification code sent successfully",
      reacquire: "Reacquire",
